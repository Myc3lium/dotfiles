...
syntax match pythonOperator "\." conceal cchar=⋅
syntax match pythonOperator "*" conceal cchar=⨯
syntax match pythonOperator "%" conceal cchar=ℵ
...
syntax match pyNiceKeyword "\<\%(math\.\)\?factorial\>" conceal cchar=!

syntax keyword pyNiceStatement lambda conceal cchar=λ
syntax keyword pyNiceStatement return conceal cchar=⊸
syntax keyword pyNiceStatement range  conceal cchar=⋯
syntax keyword pyNiceStatement fact   conceal cchar=!
